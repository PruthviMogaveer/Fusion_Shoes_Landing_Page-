      ...
      <Fade left duration={1200}>
        <div className="flex flex-1 flex-col">
          ...
          <p className="mt-4 lg:max-w-lg info-text">
            We take immense pride in our commitment to delivering nothing but
            the best when it comes to shoes. Our dedication to exceptional
            quality, craftsmanship, and customer satisfaction is unmatched.
            Explore our collection of meticulously crafted shoes that not only
